...
<div align=center class="content">
    ...
    <form action="music?command=save_artist" method="post" accept-charset="UTF-8">
        ...
        <input placeholder="<fmt:message key="form.newArtist.input.name"/>" type="text" name="name" tabindex="1" required autofocus><br/>
        <input placeholder="<fmt:message key="form.newArtist.input.country"/>" type="text" name="country" tabindex="2" required><br/>
