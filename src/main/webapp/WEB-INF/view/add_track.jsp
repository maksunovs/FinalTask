...
<div align=center class="content">
    ...
    <form action="music?command=save_audiotrack" method="post" accept-charset="UTF-8">
        ...
        <input placeholder="<fmt:message key="form.newTrack.input.title"/>" type="text" name="title" tabindex="2" required><br/>
        ...
        <input placeholder="<fmt:message key="form.newTrack.input.price"/>" name="price" type="number" min="0" step="0.01" tabindex="4" required><br/>
